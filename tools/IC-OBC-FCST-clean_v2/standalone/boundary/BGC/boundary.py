...
def fill_missing(arr, xdim='locations', zdim='z', fill='b'):
    ...
    Passing fill=None, fill=False, or fill="none" leaves values unchanged,
    which is useful for diagnostics that should expose missing regridded points.
    ...
    """
    if fill is None or fill is False or fill == 'none':
        return arr
    if fill == 'f':
